                        ...
                        <div class="row clearfix">
                            <div class="col-md-12 column">
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                    <c:forEach var="departmentfield" items="${requestScope.get('list')}" varStatus="status">

                                        <tr>
                                            <td>${departmentfield.departmentID}</td>
                                            <td>${departmentfield.departmentfieldID}</td>
                                            <td>${departmentfield.departAdd}</td>
                                            <td>
                                                <a href="<%=appPath%>/departmentfield/toUpdatedepartmentfield/depart/${departmentfield.departmentID}/field/${departmentfield.departmentfieldID}">修改</a>
                                                <a href="<%=appPath%>/departmentfield/del/depart/${departmentfield.departmentID}/field/${departmentfield.departmentfieldID}">删除</a>
                                            </td>
